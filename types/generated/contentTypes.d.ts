...
export interface ApiAboutPageAboutPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    letsChat: Schema.Attribute.Component<'fields.cta', false>;
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'fields.seo', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiBlogPageBlogPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    featuredPosts: Schema.Attribute.Component<'sections.feature-grid', false>;
    hero: Schema.Attribute.Component<'sections.hero', false>;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiCurrentPageCurrentPage extends Struct.SingleTypeSchema {
  collectionName: 'current_pages';
  info: {
    displayName: 'CurrentPage';
    pluralName: 'current-pages';
    singularName: 'current-page';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    featuredCategoriesSection: Schema.Attribute.Component<
      'sections.feature-grid',
      false
    >;
    featuredOfferingsSection: Schema.Attribute.Component<
      'sections.feature-grid',
      false
    >;
    featuredPostsSection: Schema.Attribute.Component<
      'sections.feature-grid',
      false
    >;
    featuredSeriesSection: Schema.Attribute.Component<
      'sections.feature-grid',
      false
    >;
    hero: Schema.Attribute.Component<'sections.hero', false>;
    ...
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'fields.seo', false>;
    socialLinks: Schema.Attribute.Component<'fields.social-link', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiOfferingOffering extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    offeringType: Schema.Attribute.Enumeration<
      ['course', 'guide', 'coaching', 'subscription']
    > &
      Schema.Attribute.Required;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::current-page.current-page': ApiCurrentPageCurrentPage;
